  ...
  return (
    ...
    <div className="flex flex-col gap-3">
      ...
      {soldOut ? (
        ...
        // Stacked full-width below `sm` (a stepper plus two buttons side by
        // side doesn't fit a 360-414px phone screen); from `sm` up there's
        // room, so they sit on one row, each taking half.
