...
const selectClass =
  "h-11 w-full rounded-lg border bg-background px-3 text-sm disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-input/50 disabled:opacity-50";
